...
/* Call the api for each element up to 151(the max number of pokemons on the first generation)
    and stores the info in the pokedex variable, then calls the format data function*/
